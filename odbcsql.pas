...
{ This unit handles the low level communication with ODBC !
It can behave in two different manors dependent on the compiler directive
DYNLOADINGODBC in "mODBC.INC"

If DYNLOADINGODBC is set your application will not try to load ODBC before any 
database transactions are started

If it is not set your application will locate all ODBC procedures on startup

I recommend using the DYNLOADINGODBC directive 
1) your application will start faster- (slower first login to database instead) 
2) if ODBC is not correctly installed YOU can handle this in your program instead 
   of having a dreadful "the procedure cannot be located - press OK to terminate" dialog

History

2000-08-12 Per-Eric Larsson
...
type
  TSQLGetDiagRec = function(HandleType: SQLSMALLINT;
...
type
  TSQLConnect = function(ConnectionHandle: SQLHDBC;
...
type
  TSQLDriverConnect = function(hdbc: SQLHDBC;
...
type
  TSQLExecDirect = function(StatementHandle: SQLHSTMT;
    StatementText: PSQLCHAR; TextLength: SQLINTEGER): SQLRETURN; stdcall;

type
  TSQLPrepare = function(StatementHandle: SQLHSTMT;
    StatementText: PSQLCHAR; TextLength: SQLINTEGER): SQLRETURN; stdcall;
...
type
  TSQLDescribeCol = function(StatementHandle: SQLHSTMT;
...
type
  TSQLSetStmtAttr = function(StatementHandle: SQLHSTMT;
    Attribute: SQLINTEGER; Value: SQLPOINTER;
    StringLength: SQLINTEGER): SQLRETURN; stdcall;

type
  TSQLGetStmtAttr = function(StatementHandle: SQLHSTMT;
    Attribute: SQLINTEGER; Value: SQLPOINTER;
    BufferLength: SQLINTEGER; StringLength: PSQLINTEGER): SQLRETURN; stdcall;

type
  tSQLGetInfo = function(ConnectionHandle: SQLHDBC;
    InfoType: SQLUSMALLINT; InfoValue: SQLPOINTER;
    BufferLength: SQLSMALLINT; StringLength: PSQLSMALLINT): SQLRETURN; stdcall;

type
  TSQLBulkOperations = function(StatementHandle: SQLHSTMT;
    Operation: SQLSMALLINT): SQLRETURN; stdcall;

type
  TSQLPutData = function(StatementHandle: SQLHSTMT;
...
type
  TSQLSetPos = function(hstmt: SQLHSTMT;
...
type
  TSQLDrivers = function(EnvironmentHandle: SQLHENV;
...
type
  TSQLGetCursorName = function(StatementHandle: SQLHSTMT;
...
type
  TSQLRowCount = function(StatementHandle: SQLHSTMT;
...
type
  TSQLFreeStmt = function(StatementHandle: SQLHSTMT;
    Option: SQLUSMALLINT): SQLRETURN; stdcall;

type
  TSQLColAttribute = function(StatementHandle: SQLHSTMT;
...
type
  TSQLEndTran = function(HandleType: SQLSMALLINT;
...
type
  TSQLSpecialColumns = function(StatementHandle: SQLHSTMT;
...
type
  TSQLProcedures = function(hstmt: SQLHSTMT;
    szTableQualifier: PSQLCHAR; cbTableQualifier: SQLSMALLINT;
    szTableOwner: PSQLCHAR; cbTableOwner: SQLSMALLINT;
    szTableName: PSQLCHAR; cbTableName: SQLSMALLINT): SQLRETURN; stdcall;

type
  TSQLPrimaryKeys = function(hstmt: SQLHSTMT;
...
type
  TSQLProcedureColumns = function(hstmt: SQLHSTMT;
    CatalogName: PSQLCHAR; NameLength1: SQLSMALLINT;
    SchemaName: PSQLCHAR; NameLength2: SQLSMALLINT;
    ProcName: PSQLCHAR; NameLength3: SQLSMALLINT;
    ColumnName: PSQLCHAR; NameLength4: SQLSMALLINT): SQLRETURN; stdcall;
type
  TSQLMoreResults = function(StatementHandle: SQLHSTMT): SQLRETURN; stdcall;
...
function SQLProcedureColumns(hstmt: SQLHSTMT;
  ...
  SchemaName: PSQLCHAR; NameLength2: SQLSMALLINT;
  ProcName: PSQLCHAR; NameLength3: SQLSMALLINT;
  ColumnName: PSQLCHAR; NameLength4: SQLSMALLINT): SQLRETURN; stdcall; external 'ODBC32.DLL';

function SQLMoreResults(StatementHandle: SQLHSTMT): SQLRETURN; stdcall; external 'ODBC32.DLL';
...
//Here we know the version of the odbc driver. eg '3.5'
  ...
  SQLMoreResults := GetAdresstoFunction('SQLMoreResults');
{$ENDIF}
end;
